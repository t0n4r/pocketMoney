 ...
 * @author Zahid
 */
public class AgentAdditionalInformationForm extends javax.swing.JFrame {

    /**
     * Creates new form AgentAdditionalInformationForm
     */
    public AgentAdditionalInformationForm() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgentAdditionalInformationForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgentAdditionalInformationForm().setVisible(true);
            }
        });
    }
