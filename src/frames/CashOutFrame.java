...
public class CashOutFrame extends javax.swing.JFrame {
    ...
    private void cashOutLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cashOutLabelMouseClicked
        ...
        Agent a = null;
        try {
            ObjectInputStream in = new ObjectInputStream(new FileInputStream("agentsInfo.bin"));
            while((a=(Agent)in.readObject()) != null){
                if(a.getId()==agentId){
                    getCustomer().cashOut(curCustomer, a, balance);
                }
            }
            in.close();
        } catch(Exception ex) {}
        JOptionPane.showMessageDialog(null, "Cash Out completed");
        this.dispose();
